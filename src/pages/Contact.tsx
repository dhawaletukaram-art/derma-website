...
const Contact = () => (
  <div>
    <section className="relative py-28 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h1 className="font-serif text-6xl md:text-7xl font-black bg-gradient-to-r from-slate-900 via-indigo-800 to-slate-900 bg-clip-text text-transparent leading-tight">Contact Us</h1>
          <p className="mt-5 text-lg font-medium text-slate-700">Visit Our Premium Clinics in Nagpur</p>
        </div>
      </div>
    </section>
