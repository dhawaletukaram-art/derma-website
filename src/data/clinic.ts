...
const baseServices: Service[] = [
  ...
  },
  {
    ...
    treatments: [
      ...
      { name: "Woods Lamp Examination", desc: "Advanced diagnostic tool for skin pigmentation and fungal infections." },
      { name: "Dermoscopy & Onychoscopy", desc: "Advanced diagnostics for skin and nail examination." },
      { name: "Exosomes", desc: "Advanced regenerative therapy for skin rejuvenation and healing." },
